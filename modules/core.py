...
def parse_args() -> None:
    ...
    program.add_argument('--execution-provider', help='execution provider', dest='execution_provider', default=suggest_execution_providers(), choices=suggest_execution_providers(), nargs='+')
